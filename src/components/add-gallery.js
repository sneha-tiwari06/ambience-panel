...
function AddGallery() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("galleryOverview", galleryOverview);
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="col-md-6">
           ...
           <div className="col-md-12">
            <label className="form-label">Gallery Overview</label>
            <textarea
              className="form-control"
              value={galleryOverview}
              onChange={(e) => handleInputChange("galleryOverview", e.target.value)}
            ></textarea>
            {errors.galleryOverview && (
              <small className="text-danger">{errors.galleryOverview}</small>
            )}
          </div>
        </div>
        <div className="row g-4 mb-5">
